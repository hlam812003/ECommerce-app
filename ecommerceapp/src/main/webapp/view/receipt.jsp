...
<head>
    ...
    <title>Fashi | Payment Reciept</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="place-order">
                            <h4 class="text-center">Payment Done. Thank you for purchasing our products!</h4>
                            <div class="order-total">
                                <ul class="order-table">
                                    <li>Receipt Details</li>
                                    <li class="fw-normal">Merchant <span>Fashi Ltd.</span></li>
                                    <li class="fw-normal">Payer <span>${payer.firstName} ${payer.lastName}</span></li>
                                    <li class="fw-normal">Description <span>${transaction.description} USD</span></li>
                                    <li class="fw-normal">Subtotal <span>${transaction.amount.details.subtotal} USD</span></li>
                                    <li class="fw-normal">Shipping <span>${transaction.amount.details.shipping} USD</span></li>
                                    <li class="fw-normal">Tax <span>${transaction.amount.details.tax}</span></li>
                                    <li class="total-price">Total <span>${transaction.amount.total} USD</span></li>
                                </ul>
                                <div class="order-btn">
                                    <!-- <a href="/" class="site-btn place-btn" style="background-color: #e7ab3c; border: 1px solid #e7ab3c;">Back to home</a> -->
                                    <a href="/shop" class="site-btn place-btn">Contiune Shopping</a>
                                </div>
                            </div>
                        </div>
                    </div>
