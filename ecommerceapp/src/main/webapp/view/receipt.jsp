                        ...
                        <form action="#" class="checkout-form">
                            ...
                            <input type="text" placeholder="Enter Your Coupon Code">
                                    ...
                                    <div class="place-order">
                                        <h4 class="text-center">Payment Done. Thank you for purchasing our products!
                                        </h4>
                                        <div class="order-total">
                                            <ul class="order-table">
                                                <li>Receipt Details</li>
                                                <li class="fw-normal">Merchant <span>Fashi Ltd.</span></li>
                                                <li class="fw-normal">Payer <span>${payer.firstName}
                                                        ${payer.lastName}</span></li>
                                                <li class="fw-normal">Description <span>${transaction.description}
                                                        USD</span></li>
                                                <li class="fw-normal">Subtotal
                                                    <span>${transaction.amount.details.subtotal} USD</span></li>
                                                <li class="fw-normal">Shipping
                                                    <span>${transaction.amount.details.shipping} USD</span></li>
                                                <li class="fw-normal">Tax <span>${transaction.amount.details.tax}
                                                        USD</span></li>
                                                <li class="total-price">Total <span>${transaction.amount.total}
                                                        USD</span></li>
                                            </ul>
                                            <div class="order-btn">
