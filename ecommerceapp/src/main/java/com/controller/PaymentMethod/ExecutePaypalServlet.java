            ...
            try {
                ...
                if (user != null) {
                    String htmlContent = "<html>\n"
                            ...
                            + "                <div class=\"order-item\" style=\\\"display: flex; align-items: center; justify-content: space-between;\\\">\n"
                    ...
                    for (LineItem item : invoice.getItems()) {
                        ...
                        htmlContent += "                <div class=\"order-item\" style=\\\"display: flex; align-items: center; justify-content: space-between;\\\">\n"
               ...
               htmlContent += "                <div class=\"total\" style=\\\"display: flex; align-items: center; justify-content: space-between;\\\">\n"
                            + "                    <span>Subtotal</span>\n"
                            + "                    <span>$" + subtotal + "</span>\n"
                            + "                </div>\n"
